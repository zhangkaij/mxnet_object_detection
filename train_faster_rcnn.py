...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        ...
        train_dataset = gdata.COCODetection(root=args.data_path, splits='instances_train2014')
        val_dataset = gdata.COCODetection(root=args.data_path, splits='instances_val2014', skip_empty=False)
